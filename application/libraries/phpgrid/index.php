			...
			<div class="container-fluid">
				...
				<div class="nav-collapse collapse">
					<p class="navbar-text pull-right">
						<a target="_blank" href="http://www.phpgrid.org"
							class="navbar-link">www.phpgrid.org</a>
					</p>
					<ul class="nav">
		...
		<div class="row-fluid">
			<div class="span2">
				...
				<div class="alert alert-info" align="center"
					...
					<span style="font-family: tahoma; color: red; font-size: 13px"></span>
					Advance features are available in Licensed Version. <br />
					<br /> <strong> <a style="padding: 10px" class="btn-primary"
						target="_blank" href="http://www.phpgrid.org/download/">Get
							License Today!</a>
					</strong>
				</div>
					...
					foreach ( $samples as $k => $v ) {
						...
						<div class="accordion-heading">
							<a class="accordion-toggle" data-toggle="collapse"
								data-parent="#accordion_menu" href="#collapse<?php echo $k?>"> <strong><?php echo $folder;?></strong>
							</a>
						</div>
				...
				<select name="filter" style="width: 177px"
					onchange="location.href='?filter='+this.value;">
					<option value="free"
						<?php echo ($_GET["filter"] == "free")?"selected":"";?>>Filter:
						Free Features</option>
					<option value="all"
						<?php echo ($_GET["filter"] == "all")?"selected":"";?>>Filter: All
						Features</option>
				</select>
					...
					<div class="span12">
						...
						<div class="tab-content" id="grid-demo-tabs-content">
							...
							<div id="demo" class="tab-pane fade in active">
								<span id="span_version" style="display: none"> <a
									id="div_version"
									style="margin-left: 9px; width: 100px; font-family: tahoma; padding: 5px; background-color: #117AC0; letter-spacing: 1px; color: white; text-decoration: underline;"
									target="_blank" href="http://www.phpgrid.org/download/"></a> <br>
								</span>
								<iframe onload="iframeLoaded(this)" name="demo_frame"
									frameborder="0" width="100%" height="500"
									src="demos/editing/index.php"></iframe>
							</div>

							<div id="code" class="tab-pane fade"></div>
