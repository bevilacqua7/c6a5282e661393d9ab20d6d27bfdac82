	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				</a> <a class="brand" href="#">PHP Grid Control Demos</a>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<!-- Form Name -->
				<legend>PHP Grid Installation</legend>
			
			<?php if (!empty($_POST)): ?>
				<?php if ($valid['connection']): ?>
				<div class="alert alert-success">
					<strong>Checking if connection is valid:</strong> Database
					connected.
				</div>
				<?php else: ?>
				...
				<div class="alert alert-error">
					...
					<p>
						Please copy config.sample.php to config.php and update the
						database configuration OR Try <a href="README.txt">Manual Setup</a>
					</p>
				</div>				
				<?php endif; ?>
			...
			<div class="alert alert-success">
					<strong>Checking if config writable:</strong> Your config file is
					writable.
				</div>
			<?php else: ?>
			<div class="alert alert-error">
			...
			<form class="form-horizontal" method="post">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="dbtype" name="dbtype" class="input-xlarge">
									<option value="mysqli"
										<?php echo (isset($_POST['dbtype']) && $_POST['dbtype']=='mysqli') ? "selected" : "" ?>>Mysqli</option>
									<option value="mysql"<?php echo (isset($_POST['dbtype']) && $_POST['dbtype']=='mysql') ? "selected" : "" ?>">Mysql</option>
								</select>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="dbhost" name="dbhost" type="text"
									placeholder="localhost" class="input-xlarge" required=""
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="dbuser" name="dbuser" type="text" placeholder=""
									class="input-xlarge" required=""
									value="<?php echo isset($_POST['dbuser']) ? $_POST['dbuser'] : "" ?>">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="dbpass" name="dbpass" type="password" placeholder=""
									class="input-xlarge"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="dbname" name="dbname" type="text" placeholder=""
									class="input-xlarge" required=""
									value="<?php echo isset($_POST['dbname']) ? $_POST['dbname'] : "" ?>">

								<div>
									<label class="checkbox inline" for="createdb"> <input
										name="createdb" id="createdb" value="1" type="checkbox"
										onclick="if (this.checked) jQuery('#create_tip').show();">
										Create Database <span class="help-block alert"> NOTE: If
											checked, database User must have CREATE DATABASE privilege<br>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								or <a href="README.txt">Manual Setup</a>
							</div>
						</div>
				...
				<div class="span12">
					<div class="row-fluid">
						<div class="alert alert-info">
							...
							<p class="text-info">
								For technical support query, ask at our <a
									href="http://www.phpgrid.org/support">Support Center</a>
							</p>
							<p>
								&copy; <a href="http://www.phpgrid.org">www.phpgrid.org</a> 2010-<?php echo date("Y");?></p>
						</div>
						<!--/span-->
					</div>
					<!--/row-->
