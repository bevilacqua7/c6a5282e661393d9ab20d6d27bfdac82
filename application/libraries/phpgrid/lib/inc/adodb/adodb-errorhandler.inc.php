 ...
 * @param $fn the
 *        	of the calling function (in uppercase)
 * @param $errno the
 *        	error number from the database
 * @param $errmsg the
 *        	error msg from the database
 * @param $p1 $fn
 *        	parameter - see below
 * @param $p2 $fn
 *        	parameter - see below
 * @param $thisConn $current
 *        	object - can be false if no connection object created
 *        	
 */
