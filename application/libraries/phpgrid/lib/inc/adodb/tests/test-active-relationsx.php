...
class Rugrat extends ADOdb_Active_Record {
	function __construct() {
		parent::__construct ( 'children', false, false, array (
				'new' => true 
		) );
	}
}
class Artist extends ADOdb_Active_Record {
	function __construct() {
		parent::__construct ( 'artists', array (
				'artistuniqueid' 
		) );
...
class Song extends ADOdb_Active_Record {
	function __construct() {
		parent::__construct ( 'songs', array (
				'recordid' 
		) );
...
ar_echo ( "-------------------------------------------------------------------------------------------------------------------\n" );
$person = new Person ();
$people = $person->Find ( 'id=1', false, false, array (
		'loading' => ADODB_WORK_AR 
) );
ar_echo ( (ar_assert ( found ( $people, "'name_first' => 'John'" ) )) ? "[OK] Found John\n" : "[!!] Find failed\n" );
ar_echo ( (ar_assert ( found ( $people, "'favorite_pet' => 'tortoise'" ) )) ? "[OK] Found relation: child\n" : "[!!] Missing relation: child\n" );
ar_echo ( (ar_assert ( found ( $people, "'name_first' => 'Joan'" ) )) ? "[OK] Found Joan\n" : "[!!] Find failed\n" );
...
$people = $person->Find ( 'people.id=1', false, false, array (
		'loading' => ADODB_JOIN_AR 
) );
ar_echo ( (ar_assert ( found ( $people, "'name_first' => 'John'" ) )) ? "[OK] Found John\n" : "[!!] Find failed\n" );
ar_echo ( (ar_assert ( found ( $people, "'favorite_pet' => 'tortoise'" ) )) ? "[OK] Found relation: child\n" : "[!!] Missing relation: child\n" );
ar_echo ( (ar_assert ( found ( $people, "'name_first' => 'Joan'" ) )) ? "[OK] Found Joan\n" : "[!!] Find failed\n" );
...
ar_echo ( "-------------------------------------------------------------------------------------------------------------------\n" );
$child = new Child ();
$children = $child->Find ( 'id=1', false, false, array (
		'loading' => ADODB_WORK_AR 
) );
...
$kids = $kid->Find ( 'children.id=1', false, false, array (
		'loading' => ADODB_WORK_AR 
) );
...
$rugrats = $rugrat->Find ( 'children.id=1', false, false, array (
		'loading' => ADODB_WORK_AR 
) );
...
ar_echo ( "-------------------------------------------------------------------------------------------------------------------\n" );
$person = new Person ();
$people = $person->Find ( '1=1', false, false, array (
		'loading' => ADODB_LAZY_AR 
) );
ar_echo ( (ar_assert ( found ( $people, "'name_first' => 'John'" ) )) ? "[OK] Found John\n" : "[!!] Find failed\n" );
ar_echo ( (ar_assert ( notfound ( $people, "'favorite_pet' => 'tortoise'" ) )) ? "[OK] No relation yet\n" : "[!!] Found relation when I shouldn't\n" );
...
ar_echo ( "-------------------------------------------------------------------------------------------------------------------\n" );
$artist = new Artist ();
$artists = $artist->Find ( 'artistuniqueid=1', false, false, array (
		'loading' => ADODB_JOIN_AR 
) );
...
ar_echo ( "-------------------------------------------------------------------------------------------------------------------\n" );
$song = new Song ();
$songs = $song->Find ( 'recordid=1', false, false, array (
		'loading' => ADODB_JOIN_AR 
) );
