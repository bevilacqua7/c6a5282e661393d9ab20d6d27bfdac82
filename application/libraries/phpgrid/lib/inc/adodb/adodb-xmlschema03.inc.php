 ...
 * Used for Schemas without an explicit version set.
 */
...
/**
 * Abstract DB Object.
 * This class provides basic methods for database objects, such
...
class dbIndex extends dbObject {
	...
	/**
	 *
	 * @var array options: Index-level options
	 */
	var $opts = array ();
	
	/**
	 *
	 * @var array fields: Table columns included in this index
	 */
	var $columns = array ();
	 ...
	 *
	 * @param string $opt
	 *        	Comma-separated list of index options.
...
class dbQuerySet extends dbObject {
	...
	/**
	 *
	 * @var boolean prefix enable (TRUE)
	 */
	 ...
	 *
	 * @param string $data
	 *        	Line of SQL data or NULL to initialize a new query
...
class adoSchema {
	...
	/**
	 *
	 * @var int of last Schema execution
	 */
	var $success;
	
	/**
	 *
	 * @var bool SQL inline as it is generated
	 */
	var $executeInline;
	
	/**
	 *
	 * @var bool SQL execution if errors occur
	 */
	var $continueOnError;
	
	/**
	 *
	 * @var int to handle existing data rows (insert, update, or ignore)
	 */
	var $existingData;
	 ...
	 *
	 * @param object $db
	 *        	ADOdb database connection object.
	 */
	 ...
	 *
	 * @param string $method
	 *        	Upgrade method (ALTER|REPLACE|BEST|NONE)
	 * @return s string Upgrade method used
	 */
	 ...
	 *
	 * @param int $mode
	 *        	XMLS_MODE_INSERT, XMLS_MODE_UPDATE, or XMLS_MODE_IGNORE
	 ...
	 *        	Return schema rather than parsing.
	 ...
	 *        	Array of SQL statements that will be applied rather than
	 *        	the current schema.
	 * @param boolean $continueOnErr
	 *        	Continue to apply the schema even if an error occurs.
	 * @return s integer 0 if failure, 1 if errors, 2 if successful.
	 */
	 ...
	 *
	 * @param string $format
	 *        	Format: HTML, TEXT, or NONE (PHP array)
	 ...
	 *        	Path and name where the file should be saved.
	 ...
	 *
	 * @param string $schema
	 *        	String containing XML schema that will be converted.
	 * @param string $newVersion
	 *        	DTD version to convert to.
	 * @param string $newFile
	 *        	File name of (converted) output file.
	 ...
	 *
	 * @param string $filename
	 *        	Name of XML schema file that will be converted.
	 * @param string $newVersion
	 *        	DTD version to convert to.
	 * @param string $newFile
	 *        	File name of (converted) output file.
	...
	function TransformSchema($schema, $xsl, $schematype = 'string') {
		...
		// set error handler
		xslt_set_error_handler ( $xh, array (
				&$this,
				'xslt_error_handler' 
		) );
	 ...
	 *        	If TRUE, automatically append an underscore character to the prefix.
	 ...
	 * @param string $platform
	 *        	Requested platform
	 * @return s boolean TRUE if platform check succeeds
	 *        
	 * @access private
	 */
	function supportedPlatform($platform = NULL) {
