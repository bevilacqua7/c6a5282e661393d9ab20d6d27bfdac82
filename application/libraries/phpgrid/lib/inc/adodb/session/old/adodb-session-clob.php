...
if (! defined ( 'ADODB_SESSION' )) {
	 ...
	 * \***************************************************************************************
	 */
	GLOBAL $ADODB_SESSION_CONNECT, $ADODB_SESSION_DRIVER, $ADODB_SESSION_USER, $ADODB_SESSION_PWD, $ADODB_SESSION_DB, $ADODB_SESS_CONN, $ADODB_SESS_LIFE, $ADODB_SESS_DEBUG, $ADODB_SESSION_EXPIRE_NOTIFY, $ADODB_SESSION_CRC, $ADODB_SESSION_USE_LOBS, $ADODB_SESSION_TBL;
	
	if (! isset ( $ADODB_SESSION_USE_LOBS ))
	...
	function adodb_sess_open($save_path, $session_name, $persist = true) {
		...
		GLOBAL $ADODB_SESSION_CONNECT, $ADODB_SESSION_DRIVER, $ADODB_SESSION_USER, $ADODB_SESSION_PWD, $ADODB_SESSION_DB, $ADODB_SESS_DEBUG;
...
-- Session: connection failed</p>", false );
	...
	function adodb_sess_write($key, $val) {
		global $ADODB_SESS_CONN, $ADODB_SESS_LIFE, $ADODB_SESSION_TBL, $ADODB_SESS_DEBUG, $ADODB_SESSION_CRC, $ADODB_SESSION_EXPIRE_NOTIFY, $ADODB_SESSION_DRIVER, // added
