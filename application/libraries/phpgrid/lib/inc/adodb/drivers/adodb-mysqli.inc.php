...
if (! defined ( "_ADODB_MYSQLI_LAYER" )) {
	...
	class ADODB_mysqli extends ADOConnection {
		 ...
		 *        	If false, use mysqli_real_escape_string()
		 ...
		 *
		 * @param string $ttype
		 *        	Table type = 'TABLE', 'VIEW' or false=both (default)
		 * @param string $showSchema
		 *        	schema name, false = current schema (default)
		 * @param string $mask
