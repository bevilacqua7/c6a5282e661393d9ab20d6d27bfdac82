...
if (! defined ( 'DB_OK' )) {
	 ...
	 * they are bitwised or'ed.
	 * so if there are more constants to be defined
...
class DB {
	 ...
	 *        	
	 * @param $options mixed
	 *        	if boolean (or scalar), tells whether
	 ...
	 *        
	 * @param $name the
	 *        	base name of the extension (without the .so or
	 *        	.dll suffix)
	 *        	
