...
<!-- Multiple Select -->
<link
	href="http://wenzhixin.net.cn/p/multiple-select/multiple-select.css"
	rel="stylesheet" />
<script
	src="http://wenzhixin.net.cn/p/multiple-select/jquery.multiple.select.js"></script>
...
* {
	...
	<form method="post">
		<fieldset>
			...
			Select: <select name="tables" onchange="get_fields();"
				style="width: 200px;">
			<?php
			$arr = $table_arr;
			foreach ( $arr as $rs ) {
			...
			?>
		</select> <select multiple="multiple" id="fields" name="fields[]"
				style="width: 200px;">
			<?php
